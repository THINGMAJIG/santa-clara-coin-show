...
export default function DealerApplyPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    // Using Formspree — replace FORM_ID with actual Formspree endpoint
    const res = await fetch("https://formspree.io/f/FORM_ID", {
      ...
      body: JSON.stringify({
        ...
        _subject: `Dealer Application: ${form.businessName}`,
      }),
    });
      ...
      <div className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: "var(--cream)" }}>
        <div className="max-w-md text-center p-10 bg-white rounded-xl shadow-lg">
          ...
          <p className="text-sm" style={{ color: "#555" }}>
            Thank you for applying to exhibit at the {SHOW_CONFIG.showName}. We&rsquo;ll review your application and be in touch within 5 business days to confirm your space.
          </p>
        </div>
      </div>
    );
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-2xl mx-auto">
          <form onSubmit={handleSubmit} className="space-y-5 text-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder={SHOW_CONFIG.schedule[0]?.date ?? "Upcoming show"}
                  value={form.showDate}
          ...
          <p className="text-xs mt-4 text-center" style={{ color: "#999" }}>
            ...
            or call {SHOW_CONFIG.contactPhone}.
          </p>
        </div>
      </section>
    </>
